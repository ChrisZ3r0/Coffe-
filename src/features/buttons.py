...
def button_callback(channel,pin):
...
GPIO.add_event_detect(35,GPIO.RISING,callback=button_callback(35)) # Setup event on pin 10 rising edge
GPIO.add_event_detect(36,GPIO.RISING,callback=button_callback(36)) # Setup event on pin 10 rising edge
GPIO.add_event_detect(37,GPIO.RISING,callback=button_callback(37)) # Setup event on pin 10 rising edge
GPIO.add_event_detect(38,GPIO.RISING,callback=button_callback(38)) # Setup event on pin 10 rising edge
GPIO.add_event_detect(40,GPIO.RISING,callback=button_callback(40)) # Setup event on pin 10 rising edge
